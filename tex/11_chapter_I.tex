...
My postdoctoral fellow  has been supported by Sensory Control for Unmanned Aerial Vehicles (SCUAV) \ANRshort\footnote{{\acrlong{ANR}} (ANR)
   is the French National Agency for Research. \url{http://www.agence-nationale-recherche.fr}} 
project.
...
%
Moreover, since September 2014, I am in charge of the Nuclear Energy option of the 5\up{th} year (engineer's degree, M2) of the Industrial Risk Control (MRI\footnote{In French \French{Ma\^itrise des Risques Industriels (MRI)}}) department. 
...
\begin{figure}[tb]
  \centering
  \includegraphics{fig/chapI/dfolio_timeline} %[width=1\linewidth-1ex]
...
\begin{figure}[tb]
  \centering
  \includegraphics{fig/chapI/dfolio_publisAll} %width=1\linewidth-1ex
...
Furthermore, I perform my research activities with the \PRISMEshort\footnote{{\acrlong{PRISME}} (PRISME) Laboratory is from  University of Orléans  and from \INSAshort \CVL (EPRES 4229). \url{http://www.univ-orleans.fr/PRISME}.}  
